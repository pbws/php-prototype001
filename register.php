...
<html lang="ja">
    ...
    <body>
        ...
        <h1 class="pt_title">登録</h1>
        <div class="container pt_main">
            <select class="" id="pt_sel1">
                <option value="valA">A</option>
                <option value="valB">B</option>
                <option value="valC">C</option>
                <option value="valD">D</option>
            </select>
        </div>
        ...
        <script type="text/javascript">
            $('#pt_sel1').chosen({
                ...
                width: "250px",
                placeholder_text_single: "選択して下さい"
            ...
            console.log('defaultVal:' + $('#pt_sel1').val());
        </script>
    </body>
</html>
